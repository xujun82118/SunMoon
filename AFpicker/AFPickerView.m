...
- (void)setSelectedRow:(int)selectedRow
{
    ...
    [contentView setContentOffset:CGPointMake(0.0, ROW_SPACE * currentRow+ CONTENT_OFFSET_Y) animated:NO];
}
...
- (UIBarButtonItem *)toolbarTitleItem:(NSString *)title {
    ...
    toolbarTitleLabel.textColor = [UIColor blackColor];
...
- (UIToolbar *)toolbar:(NSString *)title {
   ...
   // toolbar.tintColor = RGBACOLOR(255, 144, 39, 1);
    ...
    UIBarButtonItem *doneButton = [[UIBarButtonItem alloc] initWithTitle:@"OK" style:UIBarButtonItemStyleDone target:nil action:@selector(hidePicker)];
