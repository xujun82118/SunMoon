...
- (void)setupAnimationGroup {
    ...
    self.animationGroup.repeatCount = _eerepeatCount;
    ...
    scaleAnimation.repeatCount = _eerepeatCount;
    ...
    opacityAnimation.repeatCount = _eerepeatCount;
...
-(void)animationDidStop:(CAAnimation *)anim finished:(BOOL)flag
{
    ...
    [self.AniDelegate pulsingHaloLayerAnimationFinishedRuturn:_anikey object:self];
}
