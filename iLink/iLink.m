...
{
    return _messageTitle ?: [self localizedStringForKey:iLinkMessageTitleKey withDefault:@"Update"];
...
- (NSString *)message
{
    ...
    if (!message)
    {
        ...
        message = [self localizedStringForKey:iLinkAppMessageKey withDefault:@"\nWould you like to update it now?"];
    }
